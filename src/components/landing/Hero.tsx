import { ArrowRight, Play, Sparkles, ArrowDown, ShieldCheck, GraduationCap } from "lucide-react";
        ...
        <div className="flex flex-col gap-6 text-center lg:text-left">
          <Reveal delay={120}>
            <div className="inline-flex items-center gap-2 self-center lg:self-start px-3 py-1.5 rounded-full bg-white/60 backdrop-blur-md border border-foreground/10 text-[11px] font-medium text-foreground/70 tracking-wide uppercase">
              ...
              Beta · Built for students & freshers
            </div>
          </Reveal>
          ...
          <Reveal delay={240}>
            <p className="text-lg lg:text-xl text-foreground/65 max-w-[52ch] mx-auto lg:mx-0 leading-relaxed">
              Upload your resume, choose a target role, and get{" "}
              <span className="font-semibold text-foreground">ATS insights</span>, missing
              keywords, tailored rewrites, and interview questions — all generated by AI.
            </p>
          </Reveal>
            ...
            <div className="pt-6 mt-2 border-t border-foreground/5 grid sm:grid-cols-3 gap-3 text-left">
              <div className="flex items-start gap-2.5">
                ...
                <p className="text-xs text-foreground/65 leading-snug">
                  Built for students & freshers entering the job market.
                </p>
              </div>
              <div className="flex items-start gap-2.5">
                <Sparkles className="w-4 h-4 mt-0.5 text-foreground/70 shrink-0" />
                <p className="text-xs text-foreground/65 leading-snug">
                  Resume scores and suggestions are AI-generated.
                </p>
              </div>
              <div className="flex items-start gap-2.5">
                <ShieldCheck className="w-4 h-4 mt-0.5 text-foreground/70 shrink-0" />
                <p className="text-xs text-foreground/65 leading-snug">
                  Always verify final claims before applying.
                </p>
              </div>
            </div>
          </Reveal>

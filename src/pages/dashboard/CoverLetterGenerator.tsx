...
// Compact, purpose-built upgrade prompt shown when a Free user tries to
// generate their second cover letter. Three plans, side-by-side, with the
// most relevant value props for the cover-letter flow highlighted.
// Upgrade dialog now lives in src/components/dashboard/UpgradePlanDialog.tsx
